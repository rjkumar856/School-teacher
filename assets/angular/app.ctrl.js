...
(function() {
    ...
    angular
      ...
      AppCtrl.$inject  = ['$scope','$localStorage','$rootScope','$anchorScroll','$timeout','$window'];

      function AppCtrl($scope,$localStorage,$rootScope,$anchorScroll,$timeout,$window) {
        $rootScope.base_api_url = 'https://www.webliststore.com/busytoeasy/admin/';
        var vm = $scope;
        vm.isIE = isIE();
        vm.isSmart = isSmart();
        // config
